...
public class ForgotActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sent_id = (TextView) findViewById(R.id.sent_id);
    ...
    private void makeForgotRequest(String email) {
        ...
        Toast.makeText(this, "Link sent please check your mail", Toast.LENGTH_SHORT).show();
        sent_id.setText("Recover Link sent please check your mail");
        CustomVolleyJsonRequest jsonObjReq = new CustomVolleyJsonRequest(Request.Method.POST,
                BaseURL.FORGOT_URL, params, new Response.Listener<JSONObject>() {

            @Override
            public void onResponse(JSONObject response) {
                Log.d("dsfsdf"+TAG, response.toString());
